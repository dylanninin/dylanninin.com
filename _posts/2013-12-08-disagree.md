...
这是来自小道消息的一篇文章吵架的艺术，源自[Paul Graham](http://en.wikipedia.org/wiki/Paul_Graham_(computer_programmer))的[How to Disagree](http://www.paulgraham.com/disagree.html)，先在微博上看到配图，后来微信账号收到整篇文章，文字配图很经典，故转载；同时以此为契机一并整理关于Fenng和Paul的一些介绍。
